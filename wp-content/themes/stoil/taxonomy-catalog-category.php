...
if (get_term_by( 'id', $term->term_id, $taxonomy )) {
    $category = get_term_by( 'id', $term->term_id, $taxonomy )->slug;
} else {
    $category = false;
}
?>
    ...
    <div class="catalog-body__contents container">
        ...
        <div class="contents__content">
            <div class="content__filters">
                ...
                <?php get_template_part( 'parts/catalog', 'filter', $params ); ?>
            </div>
            <div class="content__products">
                <div class="products__categories">
                    <a class="categories__category" data-category="category-0" href="/catalog">Все категории</a>
                    <?php $terms = get_terms([
                        'taxonomy' => $taxonomy,
                        'hide_empty' => false,
                        'parent' => 0
                    ...
                    <?php if ($terms && !is_wp_error($terms)): ?>
                        <?php foreach ($terms as $term) : ?>
                            <a class="categories__category <?php if ($url == esc_url( get_term_link( $term ) )): echo 'active'; endif; ?>" href="<?= get_term_link($term->term_id, $term->taxonomy); ?>"><?= esc_html($term->name); ?></a>
                            <?php $counter++; ?>
                        <?php endforeach; ?>
                    <?php endif; ?>
                </div>
                ...
                <div class="products__product">
                    ...
                    <?php get_template_part( 'parts/catalog', 'allproducts', $params ); ?>
                </div>
            </div>
        </div>
    </div>
